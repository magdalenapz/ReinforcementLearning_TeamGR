# run with python3 ./run_client.py --server-url comprl.cs.uni-tuebingen.de --server-port 65335 --token 0f290a39-39b2-4de4-bbc8-b28ff87eb65e --args --agent=strong
...
import sys
sys.path.append('../Code/TD3-paper')
...
class HockeyAgent(Agent):
    ...
    def __init__(self, weak: bool) -> None:
        ...
        #policy_buffer = torch.load("./heat=2048", weights_only=False, map_location='cpu')
        #self.hockey_agent = policy_buffer.policies[-1]
        #print(f"Using hockey agent with elo{policy_buffer.elos[-1]}")
        self.hockey_agent = torch.load("tournament_agent", weights_only=False, map_location='cpu')
